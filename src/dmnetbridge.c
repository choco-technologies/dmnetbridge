...
dmod_dmnetbridge_api_declaration(1.0, dmnetbridge_t, _create, ( void ))
{
    ...
    struct dmnetbridge *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmnetbridge_api_declaration(1.0, void, _destroy, ( dmnetbridge_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmnetbridge_api_declaration(1.0, bool, _is_valid, ( dmnetbridge_t handle ))
{
